...
export const RETREAT_KINDS: readonly RetreatKindInfo[] = [
  { kind: 'ONZ_I', code: 'ONŻ I', name: 'Oaza Nowego Życia I stopnia' },
  { kind: 'ONZ_II', code: 'ONŻ II', name: 'Oaza Nowego Życia II stopnia' },
  { kind: 'ONZ_III', code: 'ONŻ III', name: 'Oaza Nowego Życia III stopnia' },
  { kind: 'ORAR_I', code: 'ORAR I', name: 'Oaza Rekolekcyjna Animatorów Rodzin I stopnia' },
  { kind: 'ORAR_II', code: 'ORAR II', name: 'Oaza Rekolekcyjna Animatorów Rodzin II stopnia' },
  { kind: 'PILOTOWANIE', code: 'Pilotowanie', name: 'Sesja o pilotowaniu kręgów' },
  { kind: 'ORD', code: 'ORD', name: 'Oaza Rekolekcyjna Diakonii' },
  { kind: 'INNE', code: 'Inne', name: 'Inne rekolekcje' },
] as const;
